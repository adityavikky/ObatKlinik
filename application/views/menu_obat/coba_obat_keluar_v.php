<div class="container">
    <div class="card mt-4">
        <div class="card-body">
            <h3>Form Input Obat Keluar</h3>
            <div class="form">
                <div class="">
                    <form action="<?php echo base_url('index.php/obat/insert_obat_keluar');?>" method="POST">
                        <div class="form-group mt-4">
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label for="text">Nomor Transaksi</label>
                                        <input class="form-control" type="text" value="" name="no_transaksi" required placeholder="Masukkan Nomor Transaksi">
                                        <input class="form-control" type="text" value="Keluar" name="jns_transaksi" hidden>
                                    </div>
                                    <div class="form-group">
                                        <label for="text">Nama Pasien</label>
                                        <input class="form-control" type="text" name="nama_pasien" placeholder="Masukkan Nama Pasien">
                                    </div>
                                    <div class="form-group">
                                        <label for="text">Jenis Pasien</label>
                                        <select class="form-control text-center" name="jns_pasien" id="jns_pasien">
                                ...
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <label for="text">Jenis Obat Keluar</label>
                                        <select class="form-control text-center" name="jns_transaksi" id="jns_transaksi">
                                            <option value="">--------- Pilih Jenis Obat Keluar ---------</option>
