<div class="container">
  <div class="card mt-4">
    <div class="card-body">
      ...
      <table>
        <tr>
            <form action="<?php echo base_url('index.php/dashboard/filter_daftar_masuk')?>" class="mt-4">
            ...
            <form action="<?php echo base_url('index.php/obat/print_daftar_obat_masuk');?>">
              <td>
            ...
            <form action="<?php echo base_url('index.php/dashboard/filter_daftar_masuk_hariini')?>">
              <td>
            ...
            <form action="<?php echo base_url('index.php/dashboard/filter_daftar_masuk_bulanini')?>">
              <td>
